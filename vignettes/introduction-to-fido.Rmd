...
knitr::include_graphics('https://github.com/jsilve24/fido/raw/master/vignettes/fido-lambda-all.png')
```
...
```{r echo=FALSE, fig.align='center', fig.cap='', out.width='50%'}
knitr::include_graphics('https://github.com/jsilve24/fido/raw/master/vignettes/fido-ppc.png')
```
...
```{r echo=FALSE, fig.align='center', fig.cap='', out.width='50%'}
knitr::include_graphics('https://github.com/jsilve24/fido/raw/master/vignettes/fido-ppc-scratch.png')
```
...
```{r echo=FALSE, fig.align='center', fig.cap='', out.width='50%'}
knitr::include_graphics('https://github.com/jsilve24/fido/raw/master/vignettes/fido-lambda-res.png')
```
...
```{r echo=FALSE, fig.align='center', fig.cap='', out.width='50%'}
knitr::include_graphics('https://github.com/jsilve24/fido/raw/master/vignettes/fido-lambda-cd.png')
```
...
Rather than using MCMC to sample $\eta$ fido uses MAP estimation. Additionally, *fido* allows quantification of uncertainty in MAP estimates using a Laplace approximation. We found that in practice this MAP based Laplace approximation produced 
