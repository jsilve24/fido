...
##' @rdname r2
##' @param covariates vector of indices for covariates to include in calculation
##'   of R2 (default:NULL means include all covariates by default). When
##'   non-null, all covariates not specified are set to zero for prediction.
##' @details Calculates Posterior over Linear Model R2 as:
##'   \deqn{1-\frac{SS_{res}}{SS_{tot}}}{1-(SS_(res)/SS_(tot))} where \eqn{SS}
